...
- Java
title: Java学习
updated: '2024-06-25T17:59:30.685+08:00'
---
# Java 学习
...
synchronized通过Monitor来实现线程同步，Monitor依赖于底层的操作系统的Mutex Lock实现

1. 无锁
2. 偏向锁：一段同步代码一直被一个线程所访问，那么该线程会自动获取锁，降低获取锁的代价；在Mark Word里存储锁偏向的线程ID
3. 轻量级锁：当锁是偏向锁的时候，被另外的线程所访问，偏向锁就会升级为轻量级锁，其他线程会通过自旋的形式尝试获取锁，不会阻塞
4. 重量级锁

ReentrantLock可重入锁：可以在嵌套调用时自动获得锁，避免死锁
