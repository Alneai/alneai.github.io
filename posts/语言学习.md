...
- C++
title: 语言学习
updated: '2024-11-19T15:44:45.945+08:00'
---
# Java 学习
...
Curiously Recurring Template Pattern，用来实现静态多态。通过在基类模板中使用static_cast将this转换为派生类指针实现编译期多态，避免虚函数的开销。

CRTP实现Mixin：让基类从其他类中去继承想要的方法，避免过多的继承。
...
参考：https://zhuanlan.zhihu.com/p/918102867
